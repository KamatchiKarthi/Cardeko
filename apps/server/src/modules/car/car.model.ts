...
export interface ICar {
  ...
  // Core specs
  bodyType: 'sedan' | 'suv' | 'hatchback' | 'coupe' | 'convertible' | 'truck' | 'van' | 'wagon' | 'crossover' | 'minivan'
  segment: 'micro' | 'economy' | 'compact' | 'mid-size' | 'full-size' | 'luxury' | 'sports' | 'electric'
...
const carSchema = new Schema<ICar>(
  {
    ...
    bodyType: {
      ...
      enum: ['sedan', 'suv', 'hatchback', 'coupe', 'convertible', 'truck', 'van', 'wagon', 'crossover', 'minivan'],
    },
    segment: {
      type: String, required: true, index: true,
    ...
    safetyRatingAgency: { type: String, enum: ['GLOBAL NCAP', 'BHARAT NCAP', 'EURO NCAP', 'IIHS', 'NHTSA'] },
