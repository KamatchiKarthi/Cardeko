 ...
 */
router.get('/', validateQuery(paginationQuerySchema), asyncHandler(reviewController.getCarReviews))
 ...
 */
router.post('/', validateBody(createReviewSchema), asyncHandler(reviewController.createCarReview))
